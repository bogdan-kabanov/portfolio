...
const projectsData = [
  ...
  },
  {
    ...
    image: '/blockmind/01-dashboard.png',
    images: [
      '/blockmind/01-dashboard.png',
      '/blockmind/02-trading.png',
      '/blockmind/03-screen.png',
      '/blockmind/04-screen.png',
      '/blockmind/05-screen.png',
      '/blockmind/06-screen.png',
    ],
